 ...
 */
final class Version20210726182536 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE teams (id SERIAL NOT NULL, author_id INT DEFAULT NULL, approuve_by_id INT DEFAULT NULL, name VARCHAR(70) NOT NULL, description TEXT NOT NULL, about TEXT NOT NULL, country VARCHAR(2) DEFAULT \'FR\', created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, statut SMALLINT DEFAULT -1 NOT NULL, approved SMALLINT DEFAULT 0 NOT NULL, reason TEXT DEFAULT NULL, approuved_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_96C22258F675F31B ON teams (author_id)');
        $this->addSql('CREATE INDEX IDX_96C2225840ED4ED3 ON teams (approuve_by_id)');
        $this->addSql('CREATE TABLE teams_members (id SERIAL NOT NULL, teams_id INT DEFAULT NULL, join_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, ask_for TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, accept BOOLEAN DEFAULT \'false\' NOT NULL, abouthim TEXT DEFAULT NULL, rang SMALLINT DEFAULT -1 NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_ED6F9E4BD6365F12 ON teams_members (teams_id)');
        $this->addSql('CREATE TABLE "user" (id SERIAL NOT NULL, teams_id INT DEFAULT NULL, username VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, email VARCHAR(200) NOT NULL, is_verified BOOLEAN NOT NULL, avatar_name VARCHAR(255) DEFAULT NULL, avatar_size INT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, header_name VARCHAR(255) DEFAULT NULL, header_size INT DEFAULT NULL, last_login_ip VARCHAR(255) DEFAULT NULL, last_login_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, theme VARCHAR(255) DEFAULT NULL, banned_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, country VARCHAR(2) DEFAULT \'CA\', PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649F85E0677 ON "user" (username)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649E7927C74 ON "user" (email)');
        $this->addSql('CREATE INDEX IDX_8D93D649D6365F12 ON "user" (teams_id)');
        $this->addSql('CREATE TABLE wip_attachment (id SERIAL NOT NULL, tags_id INT DEFAULT NULL, topic_id INT DEFAULT NULL, file_name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE wip_message (id SERIAL NOT NULL, topics_id INT DEFAULT NULL, author_id INT DEFAULT NULL, accepted BOOLEAN DEFAULT \'false\' NOT NULL, content TEXT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, notification BOOLEAN DEFAULT \'false\' NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE wip_tag (id SERIAL NOT NULL, author_id INT DEFAULT NULL, teams_id INT DEFAULT NULL, approuve_by_id INT DEFAULT NULL, name VARCHAR(70) NOT NULL, content TEXT NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, statut SMALLINT DEFAULT -1 NOT NULL, approved SMALLINT DEFAULT 0 NOT NULL, reason TEXT DEFAULT NULL, approuved_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_D2CFEE3F675F31B ON wip_tag (author_id)');
        $this->addSql('CREATE INDEX IDX_D2CFEE3D6365F12 ON wip_tag (teams_id)');
        $this->addSql('CREATE INDEX IDX_D2CFEE340ED4ED3 ON wip_tag (approuve_by_id)');
        $this->addSql('CREATE TABLE wip_topic (id SERIAL NOT NULL, tags_id INT NOT NULL, author_id INT NOT NULL, last_message_id INT DEFAULT NULL, approuve_by_id INT DEFAULT NULL, name VARCHAR(70) NOT NULL, content TEXT NOT NULL, solved BOOLEAN DEFAULT \'false\' NOT NULL, sticky BOOLEAN DEFAULT \'false\' NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, message_count INT DEFAULT 0 NOT NULL, statut SMALLINT DEFAULT -1 NOT NULL, approved SMALLINT DEFAULT 0 NOT NULL, reason TEXT DEFAULT NULL, approuved_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE teams ADD CONSTRAINT FK_96C22258F675F31B FOREIGN KEY (author_id) REFERENCES "user" (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE teams ADD CONSTRAINT FK_96C2225840ED4ED3 FOREIGN KEY (approuve_by_id) REFERENCES "user" (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE teams_members ADD CONSTRAINT FK_ED6F9E4BD6365F12 FOREIGN KEY (teams_id) REFERENCES teams (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE "user" ADD CONSTRAINT FK_8D93D649D6365F12 FOREIGN KEY (teams_id) REFERENCES teams_members (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE wip_tag ADD CONSTRAINT FK_D2CFEE3D6365F12 FOREIGN KEY (teams_id) REFERENCES teams (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE teams_members DROP CONSTRAINT FK_ED6F9E4BD6365F12');
        $this->addSql('ALTER TABLE wip_tag DROP CONSTRAINT FK_D2CFEE3D6365F12');
        $this->addSql('ALTER TABLE "user" DROP CONSTRAINT FK_8D93D649D6365F12');
        ...
        $this->addSql('ALTER TABLE teams DROP CONSTRAINT FK_96C22258F675F31B');
        $this->addSql('ALTER TABLE teams DROP CONSTRAINT FK_96C2225840ED4ED3');
        ...
        $this->addSql('ALTER TABLE wip_attachment DROP CONSTRAINT FK_82A6A92F8D7B4FB4');
