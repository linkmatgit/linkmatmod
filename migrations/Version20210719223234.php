 ...
 */
final class Version20210719223234 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE forum_tag ALTER title TYPE TEXT');
        $this->addSql('ALTER TABLE forum_tag ALTER title DROP DEFAULT');
        $this->addSql('ALTER TABLE forum_tag ALTER slug TYPE TEXT');
        $this->addSql('ALTER TABLE forum_tag ALTER slug DROP DEFAULT');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE forum_tag ALTER title TYPE VARCHAR(255)');
        $this->addSql('ALTER TABLE forum_tag ALTER title DROP DEFAULT');
        $this->addSql('ALTER TABLE forum_tag ALTER slug TYPE VARCHAR(255)');
        $this->addSql('ALTER TABLE forum_tag ALTER slug DROP DEFAULT');
    }
}
